...
<div class="container-fluid py-5 px-4" style="background-color: #1E388D; color: #ffffff; border-radius: 0px;">
    ...
    <div>
        ...
        <div class="d-flex gap-4 flex-wrap justify-content-center">
            <div class="card text-center border-primary" style="width: 150px; border-color: #ffffff;">
                <img src="https://via.placeholder.com/100" class="card-img-top p-3" alt="Galon Air">
                <div class="card-body">
                    <h6 class="card-title fw-bold" style="color: #ffffff;">14L</h6>
                    <p class="text-muted small" style="color: #ffffff;">Galon Air</p>
                </div>
            </div>
            <div class="card text-center border-primary" style="width: 150px; border-color: #ffffff;">
                <img src="https://via.placeholder.com/100" class="card-img-top p-3" alt="Truk Air Bersih">
                <div class="card-body">
                    <h6 class="card-title fw-bold" style="color: #ffffff;">150L</h6>
                    <p class="text-muted small" style="color: #ffffff;">Truk Air Bersih</p>
                </div>
            </div>
            <div class="card text-center border-primary" style="width: 150px; border-color: #ffffff;">
                ...
                <div class="card-body">
                    <h6 class="card-title fw-bold" style="color: #ffffff;">150L</h6>
                    <p class="text-muted small" style="color: #ffffff;">Truk Air Minum</p>
                </div>
            </div>
            <div class="card text-center border-primary" style="width: 150px; border-color: #ffffff;">
                <img src="https://via.placeholder.com/100" class="card-img-top p-3" alt="Tangki 1/2">
                <div class="card-body">
                    <h6 class="card-title fw-bold" style="color: #ffffff;">75L</h6>
                    <p class="text-muted small" style="color: #ffffff;">Tangki 1/2</p>
                </div>
            </div>
            <div class="card text-center border-primary" style="width: 150px; border-color: #ffffff;">
                <img src="https://via.placeholder.com/100" class="card-img-top p-3" alt="Tangki 1/2">
